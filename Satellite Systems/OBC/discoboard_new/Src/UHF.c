...
HAL_StatusTypeDef GET_UHF_NUM_TRANSMITTED_PACKETS(uint32_t* num_packets){
    ...
    *num_packets = 0;
    ...
    (response[6] - 0x30) <=9 ? (*num_packets += (response[6] - 0x30) << 28) : (*num_packets += (response[6] - 0x37) << 28);
    (response[7] - 0x30) <=9 ? (*num_packets += (response[7] - 0x30) << 24) : (*num_packets += (response[7] - 0x37) << 24);
    (response[8] - 0x30) <=9 ? (*num_packets += (response[8] - 0x30) << 20) : (*num_packets += (response[8] - 0x37) << 20);
    (response[9] - 0x30) <=9 ? (*num_packets += (response[9] - 0x30) << 16) : (*num_packets += (response[9] - 0x37) << 16);
    (response[10] - 0x30) <=9 ? (*num_packets += (response[10] - 0x30) << 12) : (*num_packets += (response[10] - 0x37) << 12);
    (response[11] - 0x30) <=9 ? (*num_packets += (response[11] - 0x30) << 8) : (*num_packets += (response[11] - 0x37) << 8);
	(response[12] - 0x30) <=9 ? (*num_packets += (response[12] - 0x30) << 4) : (*num_packets += (response[12] - 0x37) << 4);
	(response[13] - 0x30) <=9 ? (*num_packets += response[13] - 0x30) : (*num_packets += response[13] - 0x37);
    return status;
}
 ...
 */
HAL_StatusTypeDef GET_UHF_TEMP(uint16_t* temp){
    ...
    *temp = 0;
    ...
    (response[6] - 0x30) <=9 ? (*temp += (response[6] - 0x30) * 1000) : (*temp += (response[6] - 0x37) * 1000);
    (response[7] - 0x30) <=9 ? (*temp += (response[7] - 0x30) * 100) : (*temp += (response[7] - 0x37) * 100);
	(response[8] - 0x30) <=9 ? (*temp += (response[8] - 0x30) * 10) : (*temp += (response[8] - 0x37) * 10);
	(response[9] - 0x30) <=9 ? (*temp += response[9] - 0x30) : (*temp += response[9] - 0x37);
    return status;
}
...
HAL_StatusTypeDef GET_ANTENNA_STATUS(uint8_t* read){
    ...
    read[0] = (((response[3] - 0x30)<=9 ? (response[3] - 0x30) : (response[3] - 0x37)) << 4) | (((response[4] - 0x30)<=9 ? (response[4] - 0x30) : ((response[4] - 0x37) << 4)));
    read[1] = (((response[5] - 0x30)<=9 ? (response[5] - 0x30) : (response[5] - 0x37)) << 4) | (((response[6] - 0x30)<=9 ? (response[6] - 0x30) : ((response[6] - 0x37) << 4)));
    read[2] = (((response[7] - 0x30)<=9 ? (response[7] - 0x30) : (response[7] - 0x37)) << 4) | (((response[8] - 0x30)<=9 ? (response[8] - 0x30) : ((response[8] - 0x37) << 4)));
    return status;
}
